...
const OrderDelivered = () => {
  ...
  useEffect(() => {
    ...
    fetch(`${process.env.REACT_APP_API_BASE_URL}orders-delivered/`)
  ...
  return (
    <AdminLayout>
      <h4 className="text-center mb-3">
        <i className="fa fa-list"></i> Details of Order Delivered
      </h4>
      <div className="row">
        <div className="col-md-12 d-flex justify-content-end gap-2 align-items-center">
          <h6 className="text-muted">
            <i className="fas fa-database me-1"></i> Total  Orders Delivered
